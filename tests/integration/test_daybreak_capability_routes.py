...
_FAIL_CLOSED_HTTP_ROUTES: frozenset[_RouteKey] = frozenset(
    {
        ...
        ("HTTP", "POST", "/backend-api/codex/alpha/history/v2/{operation}"),
        ("HTTP", "POST", "/backend-api/codex/alpha/history/v2/{operation}/"),
        ("HTTP", "GET", "/backend-api/codex/alpha/notes/v2/{operation}"),
        ("HTTP", "POST", "/backend-api/codex/alpha/notes/v2/{operation}"),
        ("HTTP", "GET", "/backend-api/codex/alpha/notes/v2/{operation}/"),
        ("HTTP", "POST", "/backend-api/codex/alpha/notes/v2/{operation}/"),
        ("HTTP", "GET", "/backend-api/codex/agent-identities/jwks"),
        ("HTTP", "GET", "/plugins/featured"),
        ("HTTP", "GET", "/ps/plugins/{plugin_path:path}"),
        ...
        ("HTTP", "POST", "/v1/alpha/search"),
        ("HTTP", "POST", "/v1/alpha/history/v2/{operation}"),
        ("HTTP", "POST", "/v1/alpha/history/v2/{operation}/"),
        ("HTTP", "GET", "/v1/alpha/notes/v2/{operation}"),
        ("HTTP", "POST", "/v1/alpha/notes/v2/{operation}"),
        ("HTTP", "GET", "/v1/alpha/notes/v2/{operation}/"),
        ("HTTP", "POST", "/v1/alpha/notes/v2/{operation}/"),
...
_PROVIDER_ROUTING_CASES = [
    ...
    pytest.param("GET", "/plugins/featured", {}, id="plugin-catalog-featured"),
    pytest.param("GET", "/ps/plugins/list", {}, id="plugin-catalog-list"),
