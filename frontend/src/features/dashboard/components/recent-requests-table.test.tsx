...
describe("RecentRequestsTable account cell", () => {
  ...
  it("renders modelSourceId in account column and details dialog for model source requests", () => {
    render(
      <RecentRequestsTable
        {...PAGINATION_PROPS}
        accounts={[]}
        requests={[
          {
            ...LAYOUT_REQUEST,
            accountId: null,
            modelSourceId: "src_deepseek_chat",
    ...
    expect(screen.getByText("src_deepseek_chat")).toBeInTheDocument();
    expect(screen.queryByText("Unassigned")).not.toBeInTheDocument();

    const dialog = openRequestDetails();
    expect(within(dialog).getByText("Model Source")).toBeInTheDocument();
    expect(within(dialog).getByText("src_deepseek_chat")).toBeInTheDocument();
    expect(within(dialog).getByText("Source Kind")).toBeInTheDocument();
