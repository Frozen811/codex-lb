        ...
        try:
            ...
            async for line in iterator:
                ...
                if verbatim_type := _verbatim_relay_event_type(
                    ...
                    observe_verbatim_output_timing(output_timing, verbatim_type, line, observed_at=observed_at)
                    await _touch_api_key_reservation()
            ...
            await proxy._write_request_log(
                ...
                latency_response_created_ms=output_timing.latency_response_created_ms,
                latency_first_upstream_event_ms=output_timing.latency_first_upstream_event_ms,
